...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'CREDIT_CARD', enum: client_1.PaymentMethod }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsEnum)(client_1.PaymentMethod),
    __metadata("design:type", String)
], CreatePaymentDto.prototype, "method", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'PENDING', enum: client_1.PaymentStatus, required: false }),
